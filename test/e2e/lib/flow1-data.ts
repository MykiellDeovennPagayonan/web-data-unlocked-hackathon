...
export const FLOW1 = {
  ...
  abusers: [
    ...
    {
      name: "A. Morgan",
      email: "alexmorgan.dev@outlook.com",
      bio: "Data enthusiast building dashboards.",
      location: "Austin, TX",
    },
    {
      name: "AM User",
      email: "a.morgan.work@icloud.com",
      bio: "Data enthusiast building dashboards.",
      location: "Austin, TX",
    },
  ],
  ...
  job: {
    ...
    description:
      "Build scalable APIs and distributed systems for our core platform. You will work with Node.js, PostgreSQL, and Redis in a high-availability environment.",
    location: "Remote",
    salaryMin: 140000,
    salaryMax: 190000,
    requirements:
  ...
  application: {
    coverLetter:
      "I am excited about the opportunity to contribute to Vertex Talent. I have 6 years of experience building high-throughput APIs and microservices using Node.js and Go. I am particularly drawn to your focus on scalable architecture and would love to bring my expertise in distributed systems to your team.",
